...
*/
export function FS_BoardCount(data) { return `
...
/* ################################################################################################
    Переменных нет
*/
export function FS_BoardLogo1(data) { return `<div id="boardLogo1" class="cl_boardLogo1"></div>`;}
...
/* ################################################################################################
    Переменные:
        ...
        8) ${data['DeletePlayerLeft1Time']}  - 
*/
export function FS_BoardStart(data) { return `
...
*/
export function FS_BoardListPlayer(data) { return `
