...
<div id="boardJudges" class="cl_boardJudges">
	<div class="JudgesLeft">
		<div class="JudgesClassBoss">
			...
			<div class="JudgesBoss_Layer3_Title"><span>REFEREES</span></div>
		</div>
	</div>
	<div class="JudgesRight">
		<div class="JudgesClassLines">
			...
			<div class="JudgesBoss_Layer3_Title"><span>LINESMEN</span></div>
		</div>
	</div>
</div>
`;
...
<div id="boardCommentators" class="cl_CommentatorsWrap">
	<div class="cl_Commentators">
        ...
        <div class="cl_Commentators_Layer3_Title"><span id="Commentators_One" class="">COMMENTATOR</span><span id="Commentators_Two" class="d-none">COMMENTATORS</span></div>
	</div>
</div>
`;
    ...
    <div class="cl_boardTrainerTeam">
        <div class="cl_TrainerTeamLayer2_0">
            <div class="cl_TrainerTeamLayer2_0_1">
                <div class="cl_TrainerTeamLayer2_0_1_1">HEAD COACH</div>
    ...
    <div class="cl_boardPlayerEjection">
        <div class="cl_PlayerEjectionLayer2_0">
            <div class="cl_PlayerEjectionLayer2_0_1">
                <div class="cl_PlayerEjectionLayer2_0_1_1">PENALTY</div>
    ...
    <div class="cl_boardPlayerGoal">
        <div class="cl_PlayerGoalLayer2_0">
            <div class="cl_PlayerGoalLayer2_0_1">
                <div class="cl_PlayerGoalLayer2_0_1_1">${data['RoleEN']}</div>
    ...
    <div class="cl_boardPlayerTeam">
        <div class="cl_PlayerTeamLayer2_0">
            <div class="cl_PlayerTeamLayer2_0_1">
                <div class="cl_PlayerTeamLayer2_0_1_1">${data['RoleEN']}</div>
		...
		<div class="CountScores">
			...
			<div class="CountClassLayer1">
				...
				<div class="CountClassLineCount">
					<div id="CountClassTime">${data['Timer']}</div><div id="CountClassTimeHR"><div id="CountClassPause" class="d-none">PAUSE</div><div id="CountClassWarmUp" class="d-none"></div></div><div id="CountClassPeriodBlock" class="d-blockinline"><span id="CountENPeriod">${data['PeriodEN']}</span><span class="CountClassPeriodPost"></span></div>
				</div>
			</div>
			...
			<div class="CountClassLayer_Goal">
				<div class="CountClassLayer_Goal_Text d-none">GOOOOL!</div>
				<div class="CountClassLayer_TimeOut_Text d-none">TIMEOUT</div>
	...
	<div class="cl_boardGoal2Wrap">
		<div class="Goal2ClassScores">
			<div class="Goal2ClassLayer">
				<div class="Goal2ClassLayer_Text">GOOOOL!</div>
...
<div id="boardListPlayer" class="cl_ListPlayerWrap">
    <div class="cl_ListPlayer">
        <div class="cl_ListPlayer_Layer1">
			...
			<div class="cl_ListPlayer_Layer10">HEAD COACH</div>
            <div class="cl_ListPlayer_Layer9">${data['PlayerPlace']}</div>
			<div id="ListPlayerClassVratari"><div class="title">GOALTENDERS</div>${data['PlayerVratari']}</div>
    		<div id="ListPlayerClassSecurity"><div class="title">DEFENSEMEN</div>${data['PlayerSecurity']}</div>
    		<div id="ListPlayerClassNapadenie"><div class="title">FORWARDS</div>${data['PlayerNapadenie']}</div>
        </div>
	...
	<div class="cl_EndPeriod_Layer2_3">
		...
		<div class="cl_EndPeriod_Layer2_3_2">
			<div class="cl_boardEndPeriod__PeriodNumber">
				...
				<div class="cl_boardEndPeriod__PeriodNumber__Bottom">AFTER ${data['NumberPeriod']} PERIOD</div>
			</div>
		</div>
	</div>
</div>`;
	...
	<div class="cl_StartPeriod_Layer2_3">
		...
		<div class="cl_StartPeriod_Layer2_3_2">
			<div class="cl_boardStartPeriod__PeriodNumber">
				...
				<div class="cl_boardStartPeriod__PeriodNumber__Bottom">${data['NumberPeriod']} PERIOD</div>
			</div>
		</div>
	</div>
</div>`;
...
<div id="boardTeamRoom" class="cl_boardTeamRoom">
	<div class="TeamRoomLeft">
		<div class="TeamRoomClassBoss">
			...
			<div class="TeamRoomBoss_Layer3_Title"><span>TEAM ROOM</span></div>
		</div>
	</div>
</div>
`;
...
<div id="boardShootout_1_5" class="cl_boardShootout_1_5">
    <div id="DeletePlayerOneLineBlock" class="cl_boardShootoutPowerPlay">
        <div class="ShootoutShootoutPowerPlayScores">
            <div class="ShootoutShootoutPowerPlayScores_Text"><span id="ShootoutShootoutPowerPlayScores_Text_PowerPlay">SHOOTOUT</span></div>
        </div>
    </div>
